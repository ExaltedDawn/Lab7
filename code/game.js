...
var wobbleSpeedPower = 15;
var wobbleDistPower = .09;
Powerup.prototype.act = function(step) {
    this.wobble += step * wobbleSpeedPower;
    var wobblePos = Math.sin(this.wobble) * wobbleDistPower;
